...
class IndexService(IIndexService):
    ...
    async def console(self) -> dict:
        ...
        return {
            ...
            'version': {
                ...
                'channel': {
                    'gitee': 'https://gitee.com/default-null/sky-work',
    ...
    async def config(self) -> dict:
        ...
        return {
            ...
            'webLogo': await UrlUtil.to_absolute_url(website.get('logo', '')),
            'webFavicon': await UrlUtil.to_absolute_url(website.get('favicon', '')),
            'webBackdrop': await UrlUtil.to_absolute_url(website.get('backdrop', '')),
